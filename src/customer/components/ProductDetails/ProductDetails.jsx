    ...
    <div className="bg-white lg:px-20">
      <div className="pt-6">
        ...
        <div className="lg:col-span-1 mx-auto max-w-2xl px-4 pb-16 sm:px-6 lg:max-w-7xl lg:px-8 lg:pb-24">
          ...
          <div className="mt-4 lg:row-span-3 lg:mt-0">
            ...
            <div className="mt-6">
              ...
              <p className='ml-3 text-sm font-medium text-indigo-600 hover:text-indigo-500'>3680 Reviews</p>
        ...
        <input
          type="number"
          id="quantity"
          value={quantity} // Bind input value to the state
          onChange={(e) => setQuantity(parseInt(e.target.value) || 1)} // Update state on change
